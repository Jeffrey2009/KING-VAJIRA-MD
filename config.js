...
global.timezone  = process.env.timezone|| 'south africa'
...
module.exports = {
  sessionName: process.env.SESSION_ID || "VAJIRA;;;OriginalJessica",      //Put Your Session Id Here
  botname: process.env.speed || 'ᴠᴀᴊɪʀᴀ-ᴍᴅ',
  botbgm: process.env.BOT_BGM || 'true',
  ownername:  process.env.OWNER_NAME || `speed`,
